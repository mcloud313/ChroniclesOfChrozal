...
|---|---|---|---|
| Warrior | Might | slash | sunder: exposes armor |
| Mage | Intellect | spark | surge: burst damage |
| Cleric | Aura | smite | rebuke: damage and healing |
| Rogue | Agility | jab | ambush: executes wounded foes |
| Ranger | Agility | loose | volley: concentrated damage |
| Barbarian | Might | hew | fury: damage at a health cost |
| Druid | Aura | thorn | bloom: damage and healing |
